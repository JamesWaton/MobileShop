        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="qty d-flex pt-2">
                            ...
                            <button type="submit" class="btn font-baloo px-3 ">Save for later</button>
                        </div>
                    ...
                    <div class="col-sm-2text-right">
                        <div class="font-size-20 text-danger font-baloo">
                            $<span class="product_price ">1520.00</span>
                        </div>
                    </div>
                ...
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="col-sm-8">
                        <h5 class="font-baloo font-size-20">Readme Note 7</h5>
                        <small>Readme</small>
                        <!-- start product Rating Section -->
                        <div class="d-flex">
                            <div class="rating text-warning font-size-12">
                            ...
                            <a href="#" class="px-2 font-rale font-size-14">3,465 ratings</a>
                    ...
                    <div class="col-sm-2text-right">
                        <div class="font-size-20 text-danger font-baloo">
                            $<span class="product_price ">1120.00</span>
                        </div>
                    </div>
                ...
                <div class="col-sm-3">
                    <div class="sub-total text-center mt-2">
                        ...
                        <div class="border-top py-4">
                            <h5 class="font-baloo font-size-20">Subtotal(2 items):&nbsp;<span class="text-danger"> $<span class="text-danger" id="deal-price">2,640.00</span></span></h5>
...
<div class="container">
    <div class="row">
    <!-- using bootstrap to create the grid colum section -->
    <div class="col-lg-3 col-12">
        <h4 class="font-rubik font-size-20">Mobile shop</h4>
        <p class="font-size-14 font-rale text-white-50">Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti sit eum quis aliquid atque unde numquam eaque sunt, corporis temporibus.</p>
       </div>
       <div class="col-lg-4 col-12">
        ...
        <form class="form-row">
            ...
            <div class="col">
                <buuton type="submit" class="btn btn-primary mb-2">Subscribe</buuton>
            </div>
        </form>
       </div>
       <div class="col-lg-2 col-12">
        <h4 class="font-rubik font-size-20">Information</h4>
        <div class="d-flex felx-column flex-wrap">
...
<div class="copright text-center bg-dark text-white py-2">
    <p class="font-rale font-size-20">&copy; Copyrights 2020. Designed By <a href="#">James Watson</a></p>
</div>
   <!-- end #footer-->
...
<!-- owl Carosel JS File to connect-->
<script src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js" integrity="sha256-pTxD+DSzIwmwhOqTFN+DB+nHjO4iAsbgfyFq5K5bcE0=" crossorigin="anonymous"></script>
<!-- isotope plugin cdn (for the all bands button)  -->
